...
public class FeederController {
	...
	@RequestMapping(value="/listfeeder/{stationId}" ,produces="text/html;charset=utf-8") 
	@ResponseBody
            ...
            @PathVariable("stationId") String stationId)
	{
		...
		List<Feeder> lists = xtFeederService.listPagesByStationID(Integer.parseInt(stationId), offset, limit, order, sort);
		
		List<Map<String,Object>> listmaps = new ArrayList<Map<String,Object>>(); 
		
		for(Feeder com: lists)
		{
		...
		Map<String,Object> map = new HashMap<String, Object>();
		Long total = xtFeederService.getTatal(Integer.parseInt(stationId));
		map.put("total", total);
