...
public class DistrictController {
	...
	@RequestMapping(value="/listdistrict/{companyId}",produces="text/html;charset=utf-8")
	@ResponseBody
            ...
            @PathVariable("companyId") String companyId)
	{
		...
		List<District> lists = xtDistrictService.listPagesByCompanyID(Integer.parseInt(companyId),offset,limit,order,sort);
		
		Long total = xtDistrictService.getTatal(Integer.parseInt(companyId));
		
		List<Map<String,Object>> listmaps = new ArrayList<Map<String,Object>>(); 
		
		for(District com: lists)
		{
