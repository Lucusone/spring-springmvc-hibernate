...
/**
 * Pt entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "pt", catalog = "e8000")
...
public class Pt implements java.io.Serializable {
	...
	/** full constructor */
	public Pt(Integer id, String code, String name, String description, String rdfid, Integer equiptypeid,
