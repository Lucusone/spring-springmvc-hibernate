...
/**
 * Reactor entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "reactor", catalog = "e8000")

public class Reactor implements java.io.Serializable {
	...
	/** minimal constructor */
	public Reactor(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public Reactor(Integer id, String name, String description, String rdfid, Integer baseVoltageId, Integer districtId,
			Integer stationId, Integer bayId, Integer feederId, Integer dsubStationId, Integer inode, Integer jnode,
			Integer topoStatus, Integer runState, Integer tagStatus) {
		this.id = id;
		this.name = name;
