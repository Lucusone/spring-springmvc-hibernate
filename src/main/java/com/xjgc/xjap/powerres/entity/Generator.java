...
/**
 * Generator entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "generator", catalog = "e8000")
...
public class Generator implements java.io.Serializable {
	...
	/** minimal constructor */
	public Generator(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public Generator(Integer id, String code, String name, String description, String rdfid, Double ratedMw,
