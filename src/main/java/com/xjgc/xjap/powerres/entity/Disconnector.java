...
/**
 * Disconnector entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "disconnector", catalog = "e8000")

public class Disconnector implements java.io.Serializable {
	...
	/** minimal constructor */
	public Disconnector(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public Disconnector(Integer id, String code, String name, String description, String rdfid, Integer baseVoltageId,
			Integer districtId, Integer stationId, Integer bayId, Integer feederId, Integer dsubStationId,
			Integer compositeSwitchId, Integer equipTypeId, Integer inode, Integer jnode, Integer poleId,
			Integer scadaType, Integer status, Integer topoStatus, Integer comStatus, Integer runState,
			Integer tagStatus) {
		this.id = id;
		this.code = code;
		this.name = name;
