...
/**
 * Fuse entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "fuse", catalog = "e8000")

public class Fuse implements java.io.Serializable {
	...
	/** minimal constructor */
	public Fuse(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public Fuse(Integer id, String code, String name, String description, String rdfid, Integer baseVoltageId,
			...
			Integer status, Integer topoStatus, Integer comStatus, Integer runState, Integer tagStatus) {
		this.id = id;
		this.code = code;
		this.name = name;
