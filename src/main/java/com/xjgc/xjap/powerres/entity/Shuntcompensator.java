...
/**
 * Shuntcompensator entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "shuntcompensator", catalog = "e8000")

public class Shuntcompensator implements java.io.Serializable {
	...
	/** minimal constructor */
	public Shuntcompensator(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public Shuntcompensator(Integer id, String name, String description, String rdfid, Integer baseVoltageId,
			Integer districtId, Integer stationId, Integer bayId, Integer feederId, Integer dsubStationId,
			Integer inode, Double ratedKv, Double ratedMva, Integer topoStatus, Integer runState, Integer tagStatus) {
		this.id = id;
		this.name = name;
